...
public class EmberParticle extends TextureSheetParticle {
   ...
   protected EmberParticle(ClientLevel level, double x, double y, double z, double yd, SpriteSet spriteSet) {
      super(level, x, y, z);
      this.yd = yd;
      this.spriteSet = spriteSet;
      this.scale(0.4F);
      this.scale(Math.max((float)yd * 3.0F, 0.25F));
      this.gravity = 0.3F;
      this.friction = 0.999F;
      this.lifetime = level.random.nextInt(40, 120);
   ...
   public float getQuadSize(float scaleFactor) {
      ...
      return this.quadSize * (1.0F - f * f) * mult;
   }
