...
public class ShaderCompatibleNoise {
   public static final Sampler2D noiseSampler = new Sampler2D("assets/pmweather/textures/shader/noise.png");
   public static final Sampler2D noiseXSampler = new Sampler2D("assets/pmweather/textures/shader/noisex.png");

   public ShaderCompatibleNoise() {
   }
