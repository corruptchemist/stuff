...
public class ModBlocks {
   ...
   public static final DeferredBlock<IcicleBlock> ICICLE = registerBlock(
      "icicle",
      () -> new IcicleBlock(
            Properties.copy(net.minecraft.world.level.block.Blocks.POINTED_DRIPSTONE).randomTicks().sound(SoundType.GLASS).strength(0.25F)
         )
   );
   public static final DeferredBlock<Block> PLANTS = registerBlock(
      "plants", () -> new SeasonalPlantBlock(Properties.copy(net.minecraft.world.level.block.Blocks.GRASS).randomTicks().replaceable())
   );
   public static final DeferredBlock<Block> PLANTS_1 = registerBlock(
      "plants1", () -> new SeasonalPlantBlock(Properties.copy(net.minecraft.world.level.block.Blocks.GRASS).randomTicks().replaceable())
   );
   public static final DeferredBlock<Block> PLANTS_2 = registerBlock(
      "plants2", () -> new SeasonalPlantBlock(Properties.copy(net.minecraft.world.level.block.Blocks.GRASS).randomTicks().replaceable())
   );
   public static final DeferredBlock<Block> PLANTS_3 = registerBlock(
      "plants3", () -> new SeasonalPlantBlock(Properties.copy(net.minecraft.world.level.block.Blocks.GRASS).randomTicks().replaceable())
   );
   public static final DeferredBlock<Block> PLANTS_4 = registerBlock(
      "plants4", () -> new SeasonalPlantBlock(Properties.copy(net.minecraft.world.level.block.Blocks.GRASS).randomTicks().replaceable())
   );
   ...
   public static final DeferredBlock<Block> WEATHER_STATION = registerBlock(
      "metar", () -> new WeatherStationBlock(Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).strength(1.0F).sound(SoundType.METAL))
   );
   public static final DeferredBlock<Block> METAR = registerBlock(
      "linked_metar",
      () -> new MetarBlock(Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).strength(1.0F).sound(SoundType.METAL).noOcclusion()),
   ...
   public static final DeferredBlock<Block> ICE_LAYER = registerBlock(
      "ice_layer",
      () -> new SnowLayerBlock(Properties.copy(net.minecraft.world.level.block.Blocks.SNOW).sound(SoundType.GLASS).strength(0.15F).noOcclusion())
   );
   ...
   public static final DeferredBlock<Block> STRIPPED_ROTTED_LOG = registerBlock(
      "stripped_rotted_log", () -> new RotatedPillarBlock(Properties.copy(net.minecraft.world.level.block.Blocks.STRIPPED_OAK_LOG).strength(0.3F))
   );
   public static final DeferredBlock<Block> ROTTED_LOG = registerBlock(
      "rotted_log",
      () -> new RottedLogBlock(
            Properties.copy(net.minecraft.world.level.block.Blocks.OAK_LOG).strength(0.3F).randomTicks(), (RotatedPillarBlock)STRIPPED_ROTTED_LOG.get()
         )
   );
   public static final DeferredBlock<Block> STRIPPED_ROTTED_WOOD = registerBlock(
      "stripped_rotted_wood", () -> new RotatedPillarBlock(Properties.copy(net.minecraft.world.level.block.Blocks.STRIPPED_OAK_LOG).strength(0.3F))
   );
   public static final DeferredBlock<Block> ROTTED_WOOD = registerBlock(
      "rotted_wood",
      () -> new ModLogBlock(
            Properties.copy(net.minecraft.world.level.block.Blocks.STRIPPED_OAK_LOG).strength(0.3F), (RotatedPillarBlock)STRIPPED_ROTTED_WOOD.get()
         )
   );
   public static final DeferredBlock<Block> ROTTED_PLANKS = registerBlock(
      "rotted_planks", () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).strength(0.15F))
   );
   public static final DeferredBlock<Block> ROTTED_STAIRS = registerBlock(
      "rotted_stairs",
      () -> new StairBlock(
            ((Block)ROTTED_PLANKS.get()).defaultBlockState(), Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).strength(0.15F)
         )
   );
   public static final DeferredBlock<Block> ROTTED_SLAB = registerBlock(
      "rotted_slab", () -> new SlabBlock(Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).strength(0.15F))
   );
   ...
   public static final DeferredBlock<Block> FIRE = registerBlock(
      "fire", () -> new PMWFireBlock(Properties.copy(net.minecraft.world.level.block.Blocks.FIRE).randomTicks().replaceable())
   );
   public static final DeferredBlock<Block> CHARRED_DIRT = registerBlock(
      ...
      () -> new TransformingBlock(
            ...
            175,
            Properties.copy(net.minecraft.world.level.block.Blocks.GRASS_BLOCK).sound(SoundType.GRAVEL).randomTicks()
         )
   );
   public static final DeferredBlock<Block> SMOLDERING_DIRT = registerBlock(
      ...
      () -> new BurningBlockNoSpread(
            ...
            1,
            1000,
            Properties.copy(net.minecraft.world.level.block.Blocks.GRASS_BLOCK).sound(SoundType.GRAVEL).lightLevel(state -> 8).randomTicks()
         )
   );
   ...
   public static final DeferredBlock<Block> SMOLDERING_DIRT_SLIGHT = registerBlock(
      ...
      () -> new BurningBlockNoSpread(
            ...
            1,
            1000,
            Properties.copy(net.minecraft.world.level.block.Blocks.GRASS_BLOCK).sound(SoundType.GRAVEL).lightLevel(state -> 5).randomTicks()
         )
   );
   public static final DeferredBlock<Block> CHARRED_LOG = registerBlock(
      "charred_log", () -> new CharredLogBlock(Properties.copy(net.minecraft.world.level.block.Blocks.OAK_LOG).sound(SoundType.BASALT).randomTicks())
   );
   public static final DeferredBlock<Block> SMOLDERING_LOG = registerBlock(
      ...
      () -> new BurningLogBlock(
            ...
            1,
            1,
            Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).sound(SoundType.BASALT).lightLevel(state -> 10).randomTicks()
         )
   );
   public static final DeferredBlock<Block> CHARRED_PLANKS = registerBlock(
      "charred_planks",
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(2368548), Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).sound(SoundType.BASALT)
         )
   );
   ...
   public static final DeferredBlock<Block> CHARRED_STAIRS = registerBlock(
      ...
      () -> new ColoredFallingStairBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.OAK_PLANKS).sound(SoundType.BASALT)
         )
   );
   ...
   public static final DeferredBlock<Block> CHARRED_DOOR = registerBlock(
      "charred_door",
      () -> new CharredDoorBlock(ModBlockSetType.CHARRED, Properties.copy(net.minecraft.world.level.block.Blocks.OAK_DOOR).sound(SoundType.BASALT))
   );
   public static final DeferredBlock<Block> SMOLDERING_DOOR = registerBlock(
      ...
      () -> new BurningDoorBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.OAK_DOOR).sound(SoundType.BASALT).lightLevel(state -> 10).randomTicks()
         )
   );
   public static final DeferredBlock<Block> ASH_BLOCK = registerBlock(
      "ash_block", () -> new ColoredFallingCharredBlock(new ColorRGBA(2368548), Properties.copy(net.minecraft.world.level.block.Blocks.GRAVEL))
   );
   ...
   public static final DeferredBlock<Block> IRON_REINFORCEMENT_CORE = registerBlock(
      ...
      () -> new ReinforcedCoreBlock(Properties.copy(net.minecraft.world.level.block.Blocks.IRON_BARS).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> SCALDED_CONCRETE = registerBlock(
      "scalded_concrete",
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(6381921), Properties.copy(net.minecraft.world.level.block.Blocks.WHITE_CONCRETE).requiresCorrectToolForDrops()
         )
   );
   public static final DeferredBlock<Block> SCALDED_CONCRETE_STAIRS = registerBlock(
      ...
      () -> new ColoredFallingStairBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.WHITE_CONCRETE).requiresCorrectToolForDrops()
         )
   );
   ...
   public static final DeferredBlock<Block> SCALDED_STONE_BRICKS = registerBlock(
      ...
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(6381921), Properties.copy(net.minecraft.world.level.block.Blocks.STONE_BRICKS).requiresCorrectToolForDrops()
         )
   );
   public static final DeferredBlock<Block> SCALDED_STONE_BRICK_STAIRS = registerBlock(
      ...
      () -> new ColoredFallingStairBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.STONE_BRICKS).requiresCorrectToolForDrops()
         )
   );
   ...
   public static final DeferredBlock<Block> SCALDED_BRICKS = registerBlock(
      "scalded_bricks",
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(6381921), Properties.copy(net.minecraft.world.level.block.Blocks.BRICKS).requiresCorrectToolForDrops()
         )
   );
   public static final DeferredBlock<Block> SCALDED_BRICK_STAIRS = registerBlock(
      ...
      () -> new ColoredFallingStairBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.BRICKS).requiresCorrectToolForDrops()
         )
   );
   ...
   public static final DeferredBlock<Block> SCALDED_STONE = registerBlock(
      "scalded_stone",
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(6381921), Properties.copy(net.minecraft.world.level.block.Blocks.STONE).requiresCorrectToolForDrops()
         )
   );
   public static final DeferredBlock<Block> SCALDED_STONE_STAIRS = registerBlock(
      ...
      () -> new ColoredFallingStairBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.STONE).requiresCorrectToolForDrops()
         )
   );
   ...
   public static final DeferredBlock<Block> SCALDED_COBBLESTONE = registerBlock(
      "scalded_cobblestone",
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(6381921), Properties.copy(net.minecraft.world.level.block.Blocks.COBBLESTONE).requiresCorrectToolForDrops()
         )
   );
   public static final DeferredBlock<Block> SCALDED_COBBLESTONE_STAIRS = registerBlock(
      ...
      () -> new ColoredFallingStairBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.COBBLESTONE).requiresCorrectToolForDrops()
         )
   );
   ...
   public static final DeferredBlock<Block> SCALDED_DEEPSLATE = registerBlock(
      "scalded_deepslate",
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(6381921), Properties.copy(net.minecraft.world.level.block.Blocks.DEEPSLATE).requiresCorrectToolForDrops()
         )
   );
   public static final DeferredBlock<Block> SCALDED_DEEPSLATE_STAIRS = registerBlock(
      ...
      () -> new ColoredFallingStairBlock(
            ...
            Properties.copy(net.minecraft.world.level.block.Blocks.DEEPSLATE).requiresCorrectToolForDrops()
         )
   );
   ...
   public static final DeferredBlock<Block> SCALDED_METAL = registerBlock(
      "scalded_metal",
      () -> new ColoredFallingCharredBlock(
            new ColorRGBA(6381921), Properties.copy(net.minecraft.world.level.block.Blocks.IRON_BLOCK).requiresCorrectToolForDrops()
         )
   );
   public static final DeferredBlock<Block> REINFORCED_WHITE_CONCRETE = registerBlock(
      "reinforced_white_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.WHITE_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_WHITE_CONCRETE_POWDER = registerBlock(
      "reinforced_white_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_WHITE_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.WHITE_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_ORANGE_CONCRETE = registerBlock(
      "reinforced_orange_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.ORANGE_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_ORANGE_CONCRETE_POWDER = registerBlock(
      ...
      () -> new ConcretePowderBlock(
            (Block)REINFORCED_ORANGE_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.ORANGE_CONCRETE_POWDER)
         )
   );
   public static final DeferredBlock<Block> REINFORCED_MAGENTA_CONCRETE = registerBlock(
      "reinforced_magenta_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.MAGENTA_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_MAGENTA_CONCRETE_POWDER = registerBlock(
      ...
      () -> new ConcretePowderBlock(
            (Block)REINFORCED_MAGENTA_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.MAGENTA_CONCRETE_POWDER)
         )
   );
   public static final DeferredBlock<Block> REINFORCED_LIGHT_BLUE_CONCRETE = registerBlock(
      "reinforced_light_blue_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.LIGHT_BLUE_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_LIGHT_BLUE_CONCRETE_POWDER = registerBlock(
      ...
      () -> new ConcretePowderBlock(
            (Block)REINFORCED_LIGHT_BLUE_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.LIGHT_BLUE_CONCRETE_POWDER)
         )
   );
   public static final DeferredBlock<Block> REINFORCED_YELLOW_CONCRETE = registerBlock(
      "reinforced_yellow_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.YELLOW_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_YELLOW_CONCRETE_POWDER = registerBlock(
      "reinforced_yellow_concrete_powder",
      () -> new ConcretePowderBlock(
            (Block)REINFORCED_YELLOW_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.YELLOW_CONCRETE_POWDER)
         )
   );
   public static final DeferredBlock<Block> REINFORCED_LIME_CONCRETE = registerBlock(
      "reinforced_lime_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.LIME_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_LIME_CONCRETE_POWDER = registerBlock(
      "reinforced_lime_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_LIME_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.LIME_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_PINK_CONCRETE = registerBlock(
      "reinforced_pink_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.PINK_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_PINK_CONCRETE_POWDER = registerBlock(
      "reinforced_pink_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_PINK_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.PINK_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_GRAY_CONCRETE = registerBlock(
      "reinforced_gray_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.GRAY_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_GRAY_CONCRETE_POWDER = registerBlock(
      "reinforced_gray_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_GRAY_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.GRAY_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_LIGHT_GRAY_CONCRETE = registerBlock(
      "reinforced_light_gray_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.LIGHT_GRAY_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_LIGHT_GRAY_CONCRETE_POWDER = registerBlock(
      ...
      () -> new ConcretePowderBlock(
            (Block)REINFORCED_LIGHT_GRAY_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.LIGHT_GRAY_CONCRETE_POWDER)
         )
   );
   public static final DeferredBlock<Block> REINFORCED_CYAN_CONCRETE = registerBlock(
      "reinforced_cyan_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.CYAN_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_CYAN_CONCRETE_POWDER = registerBlock(
      "reinforced_cyan_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_CYAN_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.CYAN_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_PURPLE_CONCRETE = registerBlock(
      "reinforced_purple_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.PURPLE_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_PURPLE_CONCRETE_POWDER = registerBlock(
      "reinforced_purple_concrete_powder",
      () -> new ConcretePowderBlock(
            (Block)REINFORCED_PURPLE_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.PURPLE_CONCRETE_POWDER)
         )
   );
   public static final DeferredBlock<Block> REINFORCED_BLUE_CONCRETE = registerBlock(
      "reinforced_blue_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.BLUE_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_BLUE_CONCRETE_POWDER = registerBlock(
      "reinforced_blue_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_BLUE_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.BLUE_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_BROWN_CONCRETE = registerBlock(
      "reinforced_brown_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.BROWN_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_BROWN_CONCRETE_POWDER = registerBlock(
      "reinforced_brown_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_BROWN_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.BROWN_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_GREEN_CONCRETE = registerBlock(
      "reinforced_green_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.GREEN_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_GREEN_CONCRETE_POWDER = registerBlock(
      "reinforced_green_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_GREEN_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.GREEN_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_RED_CONCRETE = registerBlock(
      "reinforced_red_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.RED_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_RED_CONCRETE_POWDER = registerBlock(
      "reinforced_red_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_RED_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.RED_CONCRETE_POWDER))
   );
   public static final DeferredBlock<Block> REINFORCED_BLACK_CONCRETE = registerBlock(
      "reinforced_black_concrete",
      () -> new Block(Properties.copy(net.minecraft.world.level.block.Blocks.BLACK_CONCRETE).strength(3.5F).requiresCorrectToolForDrops())
   );
   public static final DeferredBlock<Block> REINFORCED_BLACK_CONCRETE_POWDER = registerBlock(
      "reinforced_black_concrete_powder",
      () -> new ConcretePowderBlock((Block)REINFORCED_BLACK_CONCRETE.get(), Properties.copy(net.minecraft.world.level.block.Blocks.BLACK_CONCRETE_POWDER))
   );
