 ...
 */
public class KnappingSiteBlock extends Block {
    public static final Component TITLE = Component.translatable("container.lithic.knapping_site");

    public KnappingSiteBlock(Properties properties) {
        super(properties);
    }
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hit) {
        ...
        KnowledgeEvents.fireStation(player, Lithic.id("knapping_site"));
        player.openMenu(new SimpleMenuProvider(
                (containerId, inventory, opener) -> new KnappingSiteMenu(
