...
public class CrudeWorkbenchMenu extends AbstractContainerMenu {
     ...
     */
    public static CrudeWorkbenchMenu forClient(int containerId, Inventory inventory, @Nullable RegistryFriendlyByteBuf data) {
        return new CrudeWorkbenchMenu(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public CrudeWorkbenchMenu(int containerId, Inventory inventory, ContainerLevelAccess access) {
        ...
        this.resultSlot = new Slot(this.resultSlots, 0, 124, 35) {
            ...
            public void onTake(Player taker, ItemStack stack) {
                ...
                CrudeWorkbenchMenu.this.consumeIngredients(taker);
                CrudeWorkbenchMenu.this.slotsChanged(CrudeWorkbenchMenu.this.craftSlots);
            }
        };
